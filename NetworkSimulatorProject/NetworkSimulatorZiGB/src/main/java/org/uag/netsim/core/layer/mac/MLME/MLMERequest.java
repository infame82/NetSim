...
public class MLMERequest implements LayerTcpRequest<MLMERequest.PRIMITIVE>{
	...
	public enum PRIMITIVE{ENERGY_DETECTION_SCAN,ACTIVE_SCAN,SET_PAN_ID,ASSOCIATION,START,GET_REGISTERED_NETWORKS,GET_REGISTERED_DEVICES,REGISTER_DEVICE,GET_EXTENDED_ADDRESS}
